    ...
    extends org.webcat.core.EOBase
{
    ...
    {
        return (ReportDataSetQuery)ec.faultForGlobalID(id, ec);
    }
     ...
     * @return An instance of this object in the target editing context
     */
    public ReportDataSetQuery refetch(EOEditingContext editingContext)
    {
        return (ReportDataSetQuery)refetchObjectFromDBinEditingContext(
            editingContext);
    }
    ...
    {
        WCFetchSpecification<ReportDataSetQuery> fspec =
            new WCFetchSpecification<ReportDataSetQuery>(
